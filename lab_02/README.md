...
Трансформация с заказами (orders) считывает данные из названной переменной выбирает определенные поля, осуществляет группировку, фильтрацию и загрузку данных в СУБД.
